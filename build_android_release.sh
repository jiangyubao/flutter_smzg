...
cd ../flutter_umpush && dart bin/create.dart com.itou.yun.cordova.xiaodian && cd ../recharge_card
cd ../flutter_wechat_plugin && dart bin/create.dart com.itou.yun.cordova.xiaodian && cd ../recharge_card
